...
// Exact-match shell routes (server ignores no query string for these). /logbook/{id} and
// /logbook/{id}/edit are deliberately NOT included — viewing or editing a past entry needs a
// live fetch of that entry anyway (see logbook.js), so there's no offline scenario this shell
// cache would actually serve for either.
